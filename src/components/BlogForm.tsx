    ...
    <h3 className="font-semibold text-xl mb-2 text-gray-800">
      ...
      <div className="space-y-4">
        ...
        <textarea
            ...
            className="block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none
            focus:ring-2 focus:ring-black resize-none h-32"
        />
      ...
      <section className="flex justify-end mt-6 space-x-4">
        ...
        <button 
            ...
            className="bg-blue-600 text-white px-6 py-2 rounded-lg font-semibold shadow-sm
        ...
        <button 
            onClick={onClose}
            className="bg-gray-500 text-white px-6 py-2 rounded-lg font-semibold shadow-sm
